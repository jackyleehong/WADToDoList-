 ...
 * {@link AddAlarm.OnButtonClickListener} interface
...
public class AddAlarm extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        Button editAlarmDialog = (Button)getActivity().findViewById(R.id.showAlarmDialog);
        editAlarmDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAlarmTimeDialog(v);
            }
        });
    }
  ...
  /*  public void onButtonPressed(Uri uri) {
    ...
    *//**
    ...
    public void showAlarmTimeDialog(View v){
        DialogFragment newFragment = new AlarmTimeDialogFragment();
